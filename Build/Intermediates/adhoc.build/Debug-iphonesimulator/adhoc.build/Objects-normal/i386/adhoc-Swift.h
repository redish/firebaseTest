...
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified room1_u1_mu1;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified room2_u1_mu2;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified room1_label;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified room2_lavel;
- (void)viewDidLoad;
- (IBAction)room1_u1_mu1_down:(id __nonnull)sender;
- (IBAction)room2_u1_mu2_down:(id __nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
